...
export default function renderScreen1() {
  ...
  app.innerHTML = `
      <div id="screen1">
        <h2>Laboratorio de Bases de Datos - App 1</h2>
        ...
        <div class="section">
          <h3>Navegación</h3>
          <button id="change-screen-btn">Ir a App2 (Morada)</button>
        </div>
  ...
  // Event listener para cambio de pantalla
  document
  ...
  async function sendEventChangeScreen() {
    try {
      // Redirigir a App2
      window.location.href = "http://localhost:5050/app2/index.html";
    } catch (error) {
      console.error("Error:", error);
    }
  }
